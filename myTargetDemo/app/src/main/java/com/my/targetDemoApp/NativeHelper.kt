...
class NativeHelper(val parent: View) : NativeAd.NativeAdListener {
    ...
    class NativeAdapter(private var nativeList: SparseArrayCompat<NativeAd>, private var nativeViewType: NativeViewType) : androidx.recyclerview.widget.RecyclerView.Adapter<NativeViewHolder>() {
